...
class Bank {
    ...
    public Account register(int p, int pa, String n, String pe,
                            String e, String type) throws RegisterException {
    ...
    public Account deposit(long id, double num) throws LoginException {
        Account t = getAct(id);
    ...
    public Account withdraw(long id, double num) throws LoginException, BalanceNotEnoughException {
    ...
    public Account setCeiling(long id, double num) throws LoginException {
    ...
    public boolean transfer(long from, long to, double money) throws LoginException, BalanceNotEnoughException {
    ...
    public Account requestLoan(long id, double money) throws LoanException, LoginException {
    ...
    public Account payLoan(long id, double money) throws LoginException, BalanceNotEnoughException {
        if (getAct(id) instanceof LoanSavingAccount) {

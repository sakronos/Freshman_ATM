public class TestSort {
    public static void main(String[] args) {
        ...
        Bank.getInstance().register(123456, "Alice", "001",
                "lzy@a.io", "LoanSavingAccount");    //3
        Bank.getInstance().register(123456, "Justin", "002",
                "lzy@a.io", "SavingAccount");    //4
        Bank.getInstance().register(123456, "Lance", "003",
                "lzy@a.io", "LoanCreditAccount");    //5
        Bank.getInstance().register(123456, "Light", "005",
